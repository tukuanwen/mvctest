package com.tu.redisDemo.mvctest.test.Reflect;
...
//        System.out.println(Integer.MAX_VALUE);
    ...
    public static void reflectPrivateMethod(){
        ...
        try {
            Class<?> aClass = Class.forName("com.tu.redisDemo.mvctest.test.Reflect.Booktkw");
            //调用的私有方法
...
//            tag.set("bookName","第一本数");
    ...
    public static void privateInitMethod() throws InstantiationException, IllegalAccessException {
        try {
            Class<?> clazz = Class.forName("com.tu.redisDemo.mvctest.test.Reflect.Booktkw");
